...
import com.tiagosan44.auction.AuctionApp;
import com.tiagosan44.auction.config.Constants;
import com.tiagosan44.auction.domain.User;
import com.tiagosan44.auction.repository.AuthorityRepository;
import com.tiagosan44.auction.repository.UserRepository;
import com.tiagosan44.auction.security.Authorities;
import com.tiagosan44.auction.security.AuthoritiesConstants;
import com.tiagosan44.auction.service.UserService;
import com.tiagosan44.auction.service.dto.PasswordChangeDTO;
...
import static com.tiagosan44.auction.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
public class AccountResourceIT {
    ...
    public void testRegisterAdminIsIgnored() throws Exception {
        ...
        assertThat(userDup.get().getAuthorities()).hasSize(1)
            .containsExactly(authorityRepository.findById(Authorities.USER.getIndex()).get());
    }
