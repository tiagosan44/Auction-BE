package com.tiagosan44.auction.service.mapper;
...
public class UserMapperTest {
    ...
    public void userDTOsToUsersWithAuthoritiesStringShouldMapToUsersWithAuthoritiesDomain() {
        ...
        assertThat(users.get(0).getAuthorities().iterator().next().getAuthority()).isEqualTo("ADMIN");
    }
    ...
    public void userDTOToUserMapWithAuthoritiesStringShouldReturnUserWithAuthorities() {
        ...
        assertThat(user.getAuthorities().iterator().next().getAuthority()).isEqualTo("ADMIN");
    }
